...
<head>
    <title>DCO Agência de Turismo</title>
    <meta charset="UTF-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-light menu">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('imgs/logo.png') }}" alt="" class="img-menu">
            </a>
                ...
                <div class="main-user-auth">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="{{ route('purchases') }}">Minhas Compras</a>
